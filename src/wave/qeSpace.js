...
// 		this.wave = new Float64Array(window.Module.HEAPF64.buffer, qe.Manifestation_getWaveBuffer(), 2 * this.nPoints);
...
// 		this.nPoints = dim.nPoints;
		...
		this.qewave = new qeWave(this, qe.Manifestation_getWaveBuffer());
