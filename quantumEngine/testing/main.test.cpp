...
//	if (actual != expected) {
//		qtMessage(" wasn't same object... %p ≠ %p: %s\n", actual, expected, msg);
//		return true;
//	}
//	return false;
//}
...
qSpace *makeBareSpace(int N) {
	qSpace *space = new qSpace("a makeBareSpace test space");
	printf("🧨 🧨 sizeof(qSpace) = %ld   alignof(qSpace) = %ld  qSpace* = 0%p\n",
